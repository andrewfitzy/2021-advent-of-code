...
process last value
split on " "
process each string - use a switch to count the occurances of 1,4,7,8 and then return a total
"""
...
if __name__ == "__main__":
    # get file content
    output_values = get_output_values("input.txt")
    output_summary = {}
    ...
    print(output_summary["2"] + output_summary["3"] + output_summary["4"] + output_summary["7"])
