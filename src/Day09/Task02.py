...
def get_basin(visited_cells, chart, column, row):
    ...
    if "left" in valid_adjacent_cells:
        coordinate = coordinate + get_basin(
            visited_cells, chart, valid_adjacent_cells["left"]["col"], valid_adjacent_cells["left"]["row"]
        )

    if "right" in valid_adjacent_cells:
        coordinate = coordinate + get_basin(
            visited_cells, chart, valid_adjacent_cells["right"]["col"], valid_adjacent_cells["right"]["row"]
        )

    if "above" in valid_adjacent_cells:
        coordinate = coordinate + get_basin(
            visited_cells, chart, valid_adjacent_cells["above"]["col"], valid_adjacent_cells["above"]["row"]
        )

    if "below" in valid_adjacent_cells:
        coordinate = coordinate + get_basin(
            visited_cells, chart, valid_adjacent_cells["below"]["col"], valid_adjacent_cells["below"]["row"]
        )
